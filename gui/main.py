...
#        widgets.tableWidget.horizontalHeader().setSectionResizeMode(QHeaderView.Stretch)
        ...
        widgets.btn_crew.clicked.connect(self.buttonClick)
    ...
    def buttonClick(self):
        ...
        if btnName == "btn_sites":
            widgets.stackedWidget.setCurrentWidget(widgets.sites)
            UIFunctions.resetStyle(self, btnName)
            btn.setStyleSheet(UIFunctions.selectMenu(btn.styleSheet()))

        if btnName == "btn_flights":
            widgets.stackedWidget.setCurrentWidget(widgets.flights)
            UIFunctions.resetStyle(self, btnName)
            btn.setStyleSheet(UIFunctions.selectMenu(btn.styleSheet()))

        if btnName == "btn_crew":
            widgets.stackedWidget.setCurrentWidget(widgets.crews)
            UIFunctions.resetStyle(self, btnName)
            btn.setStyleSheet(UIFunctions.selectMenu(btn.styleSheet()))
