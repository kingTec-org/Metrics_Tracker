...
def main_window():
	layout = [[sg.Button('Edit Crew', size=(7.5, 1), key='edit_crew_window'),
			   sg.Button('Edit Site', size=(7.5, 1), key='edit_site_window')],
...
def edit_crew_window():
	layout = [[sg.Text('')],
			  [sg.Button('Add Crew', key='add_crew_main_btn', size=(10, 1))],
