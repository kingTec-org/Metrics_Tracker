...
def main_window():
	layout = [[sg.Button('View Crew', size=(7.5, 1), key='view_crew_window'),
			   sg.Button('View Site', size=(7.5, 1), key='view_site_window')],
...
def view_crew_window():
	layout = [[sg.Button('Edit Crew', size=(7, 1), key='edit_crew_window')],[sg.Button('Close', size=(7,1))]]
...
def edit_crew_window():
	layout = [[sg.Text('Select crew member to edit')],
...
def add_crew_window():
	layout = [[sg.Text('First Name', size=(15, 1)), sg.InputText('First')],
...
# will be the main site window, leading to edit site window



def edit_site_window():
	layout = [[sg.Text('Select site to edit')],
			  [sg.Button('Add Site', key='add_site_main_btn', size=(10, 1)), sg.Button('Close', size=(10, 1))]]
...
window7 = main_window(), None, None, None, None, None, None
